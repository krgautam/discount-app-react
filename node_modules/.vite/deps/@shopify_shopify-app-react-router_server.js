...
var SHOPIFY_REACT_ROUTER_LIBRARY_VERSION = "0.1.1";
...
function overrideLogger(logger) {
  ...
  function deprecated(warningFunction2) {
    return function(version, message) {
      if (import_semver.default.gte(SHOPIFY_REACT_ROUTER_LIBRARY_VERSION, version)) {

...
function AppProvider(props) {
    return (jsxs(Fragment, { children: [props.embedded && jsx(AppBridge, { apiKey: props.apiKey }), jsx("script", { src: "https://cdn.shopify.com/shopifycloud/app-bridge-ui-experimental.js" }), props.children] }));
}
